...
from kronos.utils.file_utils import get_files, mkdir
...
class Checkpoint:
    ...
    def __init__(self, model, optimizer=None):
        ...
        Args:
            ...
            model (torch.nn.optim): A torch optimizer.
        """
        self.model = model
    ...
    def restore(self, save_path, device=None):
        ...
        try:
            ...
            try:
                ...
                logging.info(
                    "Successfully loaded model weights from {}.".format(
                        save_path
                    )
                )
                return True
    ...
    def save(self, save_path):
        ...
        # rename is POSIX-compliant and as such, is
        # an atomic operation according to the Python
        # docs: https://docs.python.org/3/library/os.html#os.rename
